...
namespace Traducteur_FrancoJaponais
{
    public static class MauiProgram
    {
        public static MauiApp CreateMauiApp()
        {
            ...
            builder.Services.AddSingleton<IDataManager<WordModel>>(new DataManagerService<WordModel>(builder.Services.BuildServiceProvider().GetService<IDataBaseService>()));
